...
IIKO_BIZ_PORT = '443'
IIKO_IT_NAME = 'Акиана Колл-центр'
...
def send_error(text):
    url = f'https://api.telegram.org/bot{5668645901:AAH-2iW1gro-F2Qdix-gLvyRmk6VJICGoP0}/sendMessage?chat_id={TELEGRAM_CHAT_ID}&text={text}'
    r = requests.get(url)
